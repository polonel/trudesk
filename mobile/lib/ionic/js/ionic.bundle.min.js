...
!(function () {
  ...
  function m (e) {
    B && ionic.tap.isTextInput(v()) && ionic.tap.isTextInput(U) && U !== e.target && (U.focus(), (U = null)),
  ...
  function S () {
    ionic.keyboard.isInitialized ||
      (V()
        ? (window.addEventListener('native.keyboardshow', pe), window.addEventListener('native.keyboardhide', x))
  ...
  function L (e, t) {
    ...
    var n,
      ...
      a = r
    return (
      (n = ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4 ? 30 : ionic.Platform.isAndroid() ? 10 : 1),
    ...
    (function (e) {
          ...
          return null === n
            ...
            : (t(),
              ...
              this.options.stop_browser_behavior &&
                e.Gestures.utils.stopDefaultBrowserBehavior(this.element, this.options.stop_browser_behavior),
      ...
      ;(e.Gestures.event = {
            ...
            if (!c.match(/mouse/) || !r) {
              ...
              i &&
                (e.Gestures.HAS_POINTEREVENTS && a != e.Gestures.EVENT_END
                  ...
                  ? (d = l.touches.length)
                  : r || (d = c.match(/up/) ? 0 : 1),
                d > 0 && a == e.Gestures.EVENT_END ? (a = e.Gestures.EVENT_MOVE) : d || (a = e.Gestures.EVENT_END),
                (d || null === n) && (n = l),
        ...
        collectEventData: function (t, n, i, r) {
          ...
          return (
            (r.type.match(/mouse/) || e.Gestures.PointerEvent.matchType(e.Gestures.POINTER_MOUSE, r)) &&
          ...
          matchType: function (t, n) {
            ...
            return (
              (i[e.Gestures.POINTER_MOUSE] =
                n.pointerType == n.MSPOINTER_TYPE_MOUSE || n.pointerType == e.Gestures.POINTER_MOUSE),
              (i[e.Gestures.POINTER_TOUCH] =
                n.pointerType == n.MSPOINTER_TYPE_TOUCH || n.pointerType == e.Gestures.POINTER_TOUCH),
        ...
        (e.Gestures.detection = {
          ...
          startDetect: function (t, n) {
            this.current ||
              ((this.stopped = !1),
              (this.current = { inst: t, startEvent: e.Gestures.utils.extend({}, n), lastEvent: !1, name: '' }),
              this.detect(n))
          },
          detect: function (t) {
          ...
          handler: function (t, n) {
            if (t.eventType == e.Gestures.EVENT_END && 'touchcancel' != t.srcEvent.type) {
              ...
              i &&
                ...
                (!r || n.options.tap_always) && ((e.Gestures.detection.current.name = 'tap'), n.trigger('tap', t))
            }
          }
        }),
            ...
            if (!(n.options.drag_max_touches > 0 && t.touches.length > n.options.drag_max_touches))
              switch (t.eventType) {
                ...
                case e.Gestures.EVENT_MOVE:
                  ...
                  if (
                    e.Gestures.detection.current.name != this.name &&
                    ((e.Gestures.detection.current.name = this.name), n.options.correct_for_drag_min_distance)
                  ) {
                  ...
                  ;(e.Gestures.detection.current.lastEvent.drag_locked_to_axis ||
                    (n.options.drag_lock_to_axis && n.options.drag_lock_min_distance <= t.distance)) &&
                  ...
                  t.drag_locked_to_axis &&
                    ...
                    (e.Gestures.utils.isVertical(r)
                      ? (t.direction = t.deltaY < 0 ? e.Gestures.DIRECTION_UP : e.Gestures.DIRECTION_DOWN)
                      : (t.direction = t.deltaX < 0 ? e.Gestures.DIRECTION_LEFT : e.Gestures.DIRECTION_RIGHT)),
                    ...
                    ((n.options.drag_block_vertical && e.Gestures.utils.isVertical(t.direction)) ||
                      (n.options.drag_block_horizontal && !e.Gestures.utils.isVertical(t.direction))) &&
                      t.preventDefault()
                  break
                case e.Gestures.EVENT_END:
        ...
        f = (n.Platform = {
            ...
            if (n) {
              ...
              if (i) {
                ...
                r.indexOf('.') > 0 ? (r = r.replace('.', '_')) : (r += '_0'),
                  ...
                  f.isAndroid() && 4.4 > i ? (t = 4 > i ? 'c' : 'b') : f.isWindowsPhone() && (t = 'b')
              }
            }
            f.setGrade(t)
          },
          ...
          setVersion: function (e) {
            if (
              'undefined' != typeof e &&
              null !== e &&
              ((e = e.split('.')), (e = parseFloat(e[0] + '.' + (e.length > 1 ? e[1] : 0))), !isNaN(e))
            )
              return void (g = e)
            g = 0
            var t = f.platform(),
          ...
          showStatusBar: function (n) {
            ;(f._showStatusBar = n),
              f.ready(function () {
                h(function () {
                  f._showStatusBar
                    ? (e.StatusBar && e.StatusBar.show(), t.body.classList.remove('status-bar-hide'))
      ...
      ;(t.CSS = {}),
        ...
        (function () {
          ...
          window.navigator.pointerEnabled
            ...
            : window.navigator.msPointerEnabled &&
              ((e = 'MSPointerDown'), (n = 'MSPointerMove'), (i = 'MSPointerUp'), (r = 'MSPointerCancel')),
  ...
  ;(ionic.tap = {
    ...
    ignoreScrollStart: function (e) {
      return (
        ...
        'true' == (e.target.dataset ? e.target.dataset.preventScroll : e.target.getAttribute('data-prevent-scroll')) ||
    ...
    isTextInput: function (e) {
      return (
        ...
        ('TEXTAREA' == e.tagName ||
          ...
          ('INPUT' == e.tagName && !/^(radio|checkbox|range|file|submit|reset|color|image|button)$/i.test(e.type)))
      )
    },
  ...
  ;(ionic.keyboard = {
    ...
    disable: function () {
      V()
        ? (window.removeEventListener('native.keyboardshow', pe), window.removeEventListener('native.keyboardhide', x))
    ...
    me.effect.Animate = {
      requestAnimationFrame: (function () {
        var t =
          ...
          n = !!t
        if ((t && !/requestAnimationFrame\(\)\s*\{\s*\[native code\]\s*\}/i.test(t.toString()) && (n = !1), n))
          return function (e, n) {
            t(e, n)
          }
        var i = 60,
    ...
    (function (e) {
      ...
      ;(e.views.Scroll = e.views.View.inherit({
        initialize: function (n) {
          ...
          ;(i.hintResize = e.debounce(
            ...
            (i.triggerScrollEvent = e.throttle(function () {
              i.onScroll(),
                e.trigger('scroll', { scrollTop: i.__scrollTop, scrollLeft: i.__scrollLeft, target: i.__container })
        ...
        __initEventHandlers: function () {
          ...
          if (
            ...
            (i.resetScrollView = function () {
              i.isShrunkForKeyboard && ((i.isShrunkForKeyboard = !1), (r.style.height = ''), (r.style.overflow = '')),
                i.resize()
            }),
            ...
            (i.touchStart = function (n) {
              if (((i.startCoordinates = e.tap.pointerCoord(n)), !e.tap.ignoreScrollStart(n))) {
                if (((i.__isDown = !0), e.tap.containsOrIsTextInput(n.target) || 'SELECT' === n.target.tagName))
            ...
            (i.touchMove = function (n) {
              if (
                !(
                  ...
                  ('TEXTAREA' === n.target.tagName && n.target.parentElement.querySelector(':focus'))
                )
              ) {
                if (!i.__hasStarted && (e.tap.containsOrIsTextInput(n.target) || 'SELECT' === n.target.tagName))
                  return (i.__hasStarted = !0), i.doTouchStart(t(n), n.timeStamp), void n.preventDefault()
            ...
            ;(i.mouseDown = function (n) {
              e.tap.ignoreScrollStart(n) ||
                ...
                (i.doTouchStart(t(n), n.timeStamp), e.tap.isTextInput(n.target) || n.preventDefault(), (a = !0))
            }),
          ...
          if (o.__indicatorX) {
            o.__indicatorY && (s = 10),
              ...
              o.__scrollLeft < 0
                ...
                : n > 0
                ? ((t = Math.max(o.__indicatorX.minScale, (o.__indicatorX.size - n) / o.__indicatorX.size)),
            ...
            o.__indicatorX.transformProp !== c &&
              ((o.__indicatorX.indicator.style[o.__transformProperty] = c), (o.__indicatorX.transformProp = c))
          }
          if (o.__indicatorY) {
            ;(a = Math.round(o.__indicatorY.sizeRatio * o.__scrollTop) || 0),
              ...
              o.__scrollTop < 0
                ...
                : i > 0
                ? ((e = Math.max(o.__indicatorY.minScale, (o.__indicatorY.size - i) / o.__indicatorY.size)),
                  (a = o.__indicatorY.maxPos - l),
                  'center bottom' !== o.__indicatorY.originProp &&
                    ((o.__indicatorY.indicator.style[o.__transformOriginProperty] = 'center bottom'),
            ...
            o.__indicatorY.transformProp !== d &&
              ((o.__indicatorY.indicator.style[o.__transformProperty] = d), (o.__indicatorY.transformProp = d))
          }
        },
        ...
        scrollTo: function (e, t, n, i, r) {
          var a = this
          if (
            (a.__isDecelerating && (me.effect.Animate.stop(a.__isDecelerating), (a.__isDecelerating = !1)),
        ...
        doTouchStart: function (e, t) {
          ...
          ;(n.__decStopped = !(!n.__isDecelerating && !n.__isAnimating)),
            ...
            n.__isDecelerating &&
              (me.effect.Animate.stop(n.__isDecelerating), (n.__isDecelerating = !1), (n.__interruptedAnimation = !0)),
            n.__isAnimating &&
              (me.effect.Animate.stop(n.__isAnimating), (n.__isAnimating = !1), (n.__interruptedAnimation = !0))
          var i,
            r,
            a = 1 === e.length
          a
            ? ((i = e[0].pageX), (r = e[0].pageY))
            : ((i = Math.abs(e[0].pageX + e[1].pageX) / 2), (r = Math.abs(e[0].pageY + e[1].pageY) / 2)),
          ...
          if (i.__isTracking) {
            ...
            if (i.__isDragging) {
              ...
              if (i.__enableScrollX) {
                ...
                ;(c > m || 0 > c) &&
                  (i.options.bouncing ? (c += (s / 2) * i.options.speedMultiplier) : (c = c > m ? m : 0))
              }
              if (i.__enableScrollY) {
                ...
                d > g || 0 > d
                  ? i.options.bouncing || (i.__refreshHeight && 0 > d)
                    ...
                    : (d = d > g ? g : 0)
                  : i.__refreshHeight && !i.__refreshHidden && (i.__refreshHide(), (i.__refreshHidden = !0))
              }
            ...
            ;(!s || u) &&
              (!c &&
                ...
                e.requestAnimationFrame(function () {
                  ;(t = Math.max(
                    0,
                    Math.min(i.__originalContainerHeight, i.__originalContainerHeight - (a.detail.keyboardHeight - 43))
                  )),
                    (r.style.height = t + 'px'),
      ...
      ;(c.prototype = new l()),
        (c.prototype.start = function (a) {
          ...
          this.canSwipe() &&
            ...
            o &&
              ...
              (l = parseFloat(o.style[e.CSS.TRANSFORM].replace('translate3d(', '').split(',')[0]) || 0),
              (s = o.parentNode.querySelector('.' + r)),
              s &&
                (s.classList.remove('invisible'),
                (c = s.offsetWidth),
                (this._currentDrag = { buttons: s, buttonsWidth: c, content: o, startOffsetX: l }))))
        }),
        ...
        (c.prototype.drag = e.animationFrameThrottle(function (t) {
          ...
          if (
            this._currentDrag &&
            (!this._isDragging &&
              (Math.abs(t.gesture.deltaX) > this.dragThresholdX || Math.abs(this._currentDrag.startOffsetX) > 0) &&
              (this._isDragging = !0),
            this._isDragging)
          ) {
        ...
        (e.views.ListView = e.views.View.inherit({
          initialize: function (t) {
            ...
            ;(t = e.extend(
              ...
              !n.itemHeight &&
                n.listEl &&
                (n.itemHeight = n.listEl.children[0] && parseInt(n.listEl.children[0].style.height, 10)),
    ...
    (function (e) {
      ...
      ;(e.views.SideMenu = e.views.View.inherit({
        ...
        (e.views.SideMenuContent = e.views.View.inherit({
          initialize: function (t) {
            e.extend(this, { animationClass: 'menu-animated', onDrag: function () {}, onEndDrag: function () {} }, t),
            ...
            if (b.offsetWidth) {
              ;(S = D.children),
                ...
                T.transitions &&
                  e.continuous &&
                  S.length < 3 &&
                  (D.appendChild(S[0].cloneNode(!0)), D.appendChild(D.children[1].cloneNode(!0)), (S = D.children)),
              ...
              for (var t = S.length; t--; ) {
                ...
                ;(n.style.width = E + 'px'),
                  ...
                  T.transitions && ((n.style.left = t * -E + 'px'), o(t, M > t ? -E : t > M ? E : 0, 0))
              }
            ...
            var L,
              ...
              z = {
                handleEvent: function (n) {
                  switch (
                    (!n.touches && n.pageX && n.pageY && (n.touches = [{ pageX: n.pageX, pageY: n.pageY }]), n.type)
                  ) {
                    case u:
                      this.start(n)
                      break
                ...
                touchmove: function (t) {
                  if (!(!t.touches || t.touches.length > 1 || (t.scale && 1 !== t.scale) || f.slideIsDisabled)) {
                    ...
                    ;(N = { x: n.pageX - k.x, y: n.pageY - k.y }),
                      ...
                      P ||
                        ...
                        d(),
                        e.continuous
                          ? (s(r(M - 1), N.x + y[r(M - 1)], 0), s(M, N.x + y[M], 0), s(r(M + 1), N.x + y[r(M + 1)], 0))
                          : (e.bouncing
                              ? (N.x =
                                  N.x / ((!M && N.x > 0) || (M == S.length - 1 && N.x < 0) ? Math.abs(N.x) / E + 1 : 1))
                  ...
                  P ||
                    (n && !i
                      ? (a
                          ? (e.continuous ? (o(r(M - 1), -E, 0), o(r(M + 2), E, 0)) : o(M - 1, -E, 0),
                            o(M, y[M] - E, C),
                            o(r(M + 1), y[r(M + 1)] - E, C),
                            (M = r(M + 1)))
                          : (e.continuous ? (o(r(M + 1), E, 0), o(r(M - 2), -E, 0)) : o(M + 1, E, 0),
        ...
        n = function (e, r, a, o) {
          ...
          function h (e) {
            ...
            if (0 !== n) {
              ...
              return (
                y.params.autoplay && y.stopAutoplay(), e.preventDefault ? e.preventDefault() : (e.returnValue = !1), !1
              )
            }
          }
          function f (e, n) {
            ...
            ;(i = e.attr('data-swiper-parallax') || '0'),
              ...
              r || a ? ((r = r || '0'), (a = a || '0')) : s() ? ((r = i), (a = '0')) : ((a = i), (r = '0')),
          ...
          if (
            ...
            ;(y.container[0].swiper = y),
              ...
              (y.rtl = s() && ('rtl' === y.container[0].dir.toLowerCase() || 'rtl' === y.container.css('direction'))),
              ...
              (y.loadImage = function (e, t, n, i, r) {
                ...
                e.complete && i
                  ? a()
                  : t
                  ? ((o = new window.Image()), (o.onload = a), (o.onerror = a), n && (o.srcset = n), t && (o.src = t))
                  : a()
              }),
              ...
              (y.updateSlidesSize = function () {
                ...
                for (e = 0; e < y.slides.length; e++) {
                  ...
                  if (y.params.slidesPerColumn > 1) {
                    ...
                    'column' === y.params.slidesPerColumnFill
                      ...
                      p
                        .css({ 'margin-top': 0 !== m && y.params.spaceBetween && y.params.spaceBetween + 'px' })
                        .attr('data-swiper-column', f)
                        .attr('data-swiper-row', m)
                  }
                  'none' !== p.css('display') &&
                    ('auto' === y.params.slidesPerView
                      ? ((o = s() ? p.outerWidth(!0) : p.outerHeight(!0)), y.params.roundLengths && (o = l(o)))
                      : ((o = (y.size - (y.params.slidesPerView - 1) * t) / y.params.slidesPerView),
                        y.params.roundLengths && (o = l(o)),
                        s() ? (y.slides[e].style.width = o + 'px') : (y.slides[e].style.height = o + 'px')),
                ...
                if (!y.params.centeredSlides) {
                  ...
                  ;(y.snapGrid = g),
                    Math.floor(y.virtualSize - y.size) > Math.floor(y.snapGrid[y.snapGrid.length - 1]) &&
              ...
              (y.updateActiveIndex = function () {
                ...
                for (t = 0; t < y.slidesGrid.length; t++)
                  'undefined' != typeof y.slidesGrid[t + 1]
                    ? i >= y.slidesGrid[t] && i < y.slidesGrid[t + 1] - (y.slidesGrid[t + 1] - y.slidesGrid[t]) / 2
                      ? (e = t)
                ...
                ;(0 > e || 'undefined' == typeof e) && (e = 0),
                  ...
                  e !== y.activeIndex &&
                    ((y.snapIndex = n), (y.previousIndex = y.activeIndex), (y.activeIndex = e), y.updateClasses())
              }),
              (y.updateClasses = function () {
                y.slides.removeClass(
                  y.params.slideActiveClass + ' ' + y.params.slideNextClass + ' ' + y.params.slidePrevClass
                )
                ...
                if (
                  ...
                  y.params.loop
                    ? ((n = Math.ceil(y.activeIndex - y.loopedSlides) / y.params.slidesPerGroup),
                      n > y.slides.length - 1 - 2 * y.loopedSlides && (n -= y.slides.length - 2 * y.loopedSlides),
              ...
              (y.updatePagination = function () {
                if (y.params.pagination && y.paginationContainer && y.paginationContainer.length > 0) {
                  for (
                    var e = '',
                      t = y.params.loop
                        ? Math.ceil((y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup)
                        : y.snapGrid.length,
                      n = 0;
                    t > n;
                    n++
            ...
            window.navigator.pointerEnabled
              ...
              : window.navigator.msPointerEnabled && (E = ['MSPointerDown', 'MSPointerMove', 'MSPointerUp']),
              (y.touchEvents = {
              ...
              (y.initEvents = function (e) {
                ...
                y.browser.ie
                  ...
                  y.params.nextButton &&
                    ...
                    y.params.a11y && y.a11y && t(y.params.nextButton)[n]('keydown', y.a11y.onEnterKey)),
                  y.params.prevButton &&
                    (t(y.params.prevButton)[n]('click', y.onClickPrev),
                    y.params.a11y && y.a11y && t(y.params.prevButton)[n]('keydown', y.a11y.onEnterKey)),
                  y.params.pagination &&
                    y.params.paginationClickable &&
                    (t(y.paginationContainer)[n]('click', '.' + y.params.bulletClass, y.onClickIndex),
                    y.params.a11y &&
                      y.a11y &&
                      t(y.paginationContainer)[n]('keydown', '.' + y.params.bulletClass, y.a11y.onEnterKey)),
            ...
            if (
              ...
              (y.onTouchMove = function (e) {
                if (
                  ...
                  if (V && document.activeElement && e.target === document.activeElement && t(e.target).is(O))
                      ...
                      if (R || !y.browser.ieTouch) {
                        ;(y.allowClick = !1),
                          ...
                          D ||
                            ...
                            y.params.autoplay &&
                              y.autoplaying &&
                              (y.params.autoplayDisableOnInteraction ? y.stopAutoplay() : y.pauseAutoplay()),
                            (z = !1),
                            y.params.grabCursor &&
                              ((y.container[0].style.cursor = 'move'),
                        ...
                        if (
                          (i > 0 && P > y.minTranslate()
                            ? ((a = !1),
                              y.params.resistance &&
                                (P =
                                  y.minTranslate() - 1 + Math.pow(-y.minTranslate() + I + i, y.params.resistanceRatio)))
                            : 0 > i &&
                              P < y.maxTranslate() &&
                              ((a = !1),
                              y.params.resistance &&
                                (P =
                                  y.maxTranslate() + 1 - Math.pow(y.maxTranslate() - I - i, y.params.resistanceRatio))),
                          ...
                          ;(y.params.freeMode || y.params.watchSlidesProgress) && y.updateActiveIndex(),
                            y.params.freeMode &&
                              (0 === G.length && G.push({ position: y.touches[s() ? 'startX' : 'startY'], time: C }),
                              G.push({
                ...
                if ((e.originalEvent && (e = e.originalEvent), M && y.emit('onTouchEnd', y, e), (M = !1), x)) {
                  ...
                  if (
                    (y.allowClick &&
                      ...
                      300 > i && 300 > n - A && (N && clearTimeout(N), y.emit('onDoubleTap', y, e))),
                    (A = Date.now()),
                    setTimeout(function () {
                      y && (y.allowClick = !0)
                    }, 0),
                    ...
                    if (y.params.freeModeMomentum) {
                      if (G.length > 1) {
                        ...
                        ;(y.velocity = s / l),
                          ...
                          (l > 150 || new window.Date().getTime() - a.time > 300) && (y.velocity = 0)
                      } else y.velocity = 0
                      G.length = 0
                      ...
                      if (u < y.maxTranslate())
                        ...
                        ;(u =
                          Math.abs(y.snapGrid[m] - u) < Math.abs(y.snapGrid[m - 1] - u) || 'next' === y.swipeDirection
                            ? y.snapGrid[m]
                            : y.snapGrid[m - 1]),
                          y.rtl || (u = -u)
                      }
                  ...
                  for (v = 0; v < y.slidesGrid.length; v += y.params.slidesPerGroup)
                    'undefined' != typeof y.slidesGrid[v + y.params.slidesPerGroup]
                      ...
                      : r >= y.slidesGrid[v] &&
                        ((_ = v), (w = y.slidesGrid[y.slidesGrid.length - 1] - y.slidesGrid[y.slidesGrid.length - 2]))
                  var T = (r - y.slidesGrid[_]) / w
                  if (i > y.params.longSwipesMs) {
                    if (!y.params.longSwipes) return void y.slideTo(y.activeIndex)
                    'next' === y.swipeDirection &&
                      (T >= y.params.longSwipesRatio ? y.slideTo(_ + y.params.slidesPerGroup) : y.slideTo(_)),
                      'prev' === y.swipeDirection &&
                        (T > 1 - y.params.longSwipesRatio ? y.slideTo(_ + y.params.slidesPerGroup) : y.slideTo(_))
                  } else {
              ...
              (y.slideTo = function (e, t, n, i) {
                ...
                y.params.autoplay &&
                  y.autoplaying &&
                  (i || !y.params.autoplayDisableOnInteraction ? y.pauseAutoplay(t) : y.stopAutoplay()),
                  y.updateProgress(r)
                  ...
                  : ('undefined' == typeof t && (t = y.params.speed),
                    ...
                    (y.rtl && -r === y.translate) || (!y.rtl && r === y.translate)
                      ...
                      : (y.updateClasses(),
                        ...
                        0 === t
                          ? (y.setWrapperTranslate(r), y.setWrapperTransition(0), y.onTransitionEnd(n))
                          : (y.setWrapperTranslate(r),
                    ...
                    : ((r = window.getComputedStyle(e, null)),
                      window.WebKitCSSMatrix
                        ...
                        : ((a =
                          ...
                          (n = a.toString().split(','))),
                      'x' === t &&
                        (i = window.WebKitCSSMatrix ? a.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])),
                      'y' === t &&
                        (i = window.WebKitCSSMatrix ? a.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5])),
                      y.rtl && i && (i = -i),
                      i || 0)
                )
              }),
                ...
                cube: {
                  setTranslate: function () {
                    ...
                    y.params.cube.shadow &&
                      (s()
                        ? ((e = y.wrapper.find('.swiper-cube-shadow')),
                          0 === e.length && ((e = t('<div class="swiper-cube-shadow"></div>')), y.wrapper.append(e)),
                          e.css({ height: y.width + 'px' }))
                        : ((e = y.container.find('.swiper-cube-shadow')),
                          0 === e.length && ((e = t('<div class="swiper-cube-shadow"></div>')), y.container.append(e))))
                    for (var i = 0; i < y.slides.length; i++) {
                      ...
                      var p =
                        ...
                        'px)'
                      if (
                        (1 >= l && l > -1 && ((n = 90 * i + 90 * l), y.rtl && (n = 90 * -i - 90 * l)),
                        r.transform(p),
                        ...
                        0 === h.length &&
                          ((h = t('<div class="swiper-slide-shadow-' + (s() ? 'left' : 'top') + '"></div>')),
                          r.append(h)),
                          0 === f.length &&
                            ((f = t('<div class="swiper-slide-shadow-' + (s() ? 'right' : 'bottom') + '"></div>')),
                            r.append(f))
                        r[0].progress
                  ...
                  setTransition: function (e) {
                    y.slides
                      ...
                      .transition(e),
                      y.params.cube.shadow && !s() && y.container.find('.swiper-cube-shadow').transition(e)
                  }
                },
                coverflow: {
                  setTranslate: function () {
                    for (
                      ...
                      var v =
                        'translate3d(' + g + 'px,' + m + 'px,' + f + 'px)  rotateX(' + h + 'deg) rotateY(' + p + 'deg)'
                      if (
                        (l.transform(v),
                        ...
                        0 === _.length &&
                          ((_ = t('<div class="swiper-slide-shadow-' + (s() ? 'left' : 'top') + '"></div>')),
                          l.append(_)),
                          0 === w.length &&
                            ((w = t('<div class="swiper-slide-shadow-' + (s() ? 'right' : 'bottom') + '"></div>')),
                            l.append(w)),
                            ...
                            if (
                              ...
                              if (i.hasClass(y.params.slideDuplicateClass)) {
                                var s = y.wrapper.children(
                                  '[data-swiper-slide-index="' + t + '"]:not(.' + y.params.slideDuplicateClass + ')'
                                )
                                y.lazy.loadImageInSlide(s.index(), !1)
                              } else {
                                var l = y.wrapper.children(
                                  '.' + y.params.slideDuplicateClass + '[data-swiper-slide-index="' + t + '"]'
                                )
              ...
              (y.controller = {
                ...
                setTranslate: function (e, t) {
                  function i (t) {
                    ;(e = t.rtl && 'horizontal' === t.params.direction ? -y.translate : y.translate),
                      'slide' === y.params.controlBy &&
                        (y.controller.getInterpolateFunction(t), (a = -y.controller.spline.interpolate(-e))),
                      (a && 'container' !== y.params.controlBy) ||
                        ((r = (t.maxTranslate() - t.minTranslate()) / (y.maxTranslate() - y.minTranslate())),
                  ...
                  var r,
                    a,
                    o = y.params.control
                  if (y.isArray(o)) for (var s = 0; s < o.length; s++) o[s] !== t && o[s] instanceof n && i(o[s])
                ...
                setTransition: function (e, t) {
                  ...
                  var r,
                    a = y.params.control
                  if (y.isArray(a)) for (r = 0; r < a.length; r++) a[r] !== t && a[r] instanceof n && i(a[r])
            ...
            return (
              (y.callPlugins = function (e) {
                for (var t = 0; t < y._plugins.length; t++)
                  e in y._plugins[t] &&
                    y._plugins[t][e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
              }),
                ...
                onEnterKey: function (e) {
                  13 === e.keyCode &&
                    (t(e.target).is(y.params.nextButton)
                      ? (y.onClickNext(e),
                        y.isEnd ? y.a11y.notify(y.params.lastSlideMessage) : y.a11y.notify(y.params.nextSlideMessage))
              ...
              (y.init = function () {
                y.params.loop && y.createLoop(),
                  ...
                  y.params.scrollbar &&
                    y.scrollbar &&
                    (y.scrollbar.set(), y.params.scrollbarDraggable && y.scrollbar.enableDraggable()),
                  'slide' !== y.params.effect &&
                    y.effects[y.params.effect] &&
              ...
              (e.prototype = {
                ...
                on: function (e, n, i, r) {
                  function a (e) {
                    ...
                    else for (var a = t(r).parents(), o = 0; o < a.length; o++) t(a[o]).is(n) && i.call(a[o], e)
                  }
                  var o,
                    s,
                    l = e.split(' ')
                  for (o = 0; o < this.length; o++)
                    if ('function' == typeof n || n === !1)
                      for (
                        'function' == typeof n && ((i = arguments[1]), (r = arguments[2] || !1)), s = 0;
                        s < l.length;
                        s++
                      )
                      ...
                      if ('function' == typeof t || t === !1)
                        ...
                        for (var s = 0; s < this[o].dom7LiveListeners.length; s++)
                          this[o].dom7LiveListeners[s].listener === n &&
                            this[o].removeEventListener(r[a], this[o].dom7LiveListeners[s].liveListener, i)
                  return this
                },
    ...
    (function (e) {
      ...
      e.views.Toggle = e.views.View.inherit({
        ...
        val: function (t) {
          return (
            (t === !0 || t === !1) &&
              ('' !== this.handle.style[e.CSS.TRANSFORM] && (this.handle.style[e.CSS.TRANSFORM] = ''),
...
;(function (T, P, u) {
  ...
  function xc (a) {
    ...
    q((a || '').split('&'), function (a) {
      ...
      a &&
        ...
        (e = wc(e)),
        A(e) && ((f = A(f) ? wc(f) : !0), va.call(b, e) ? (M(b[e]) ? b[e].push(f) : (b[e] = [b[e], f])) : (b[e] = f)))
    })
    return b
  }
  function Sb (a) {
  ...
  function gb (a, b) {
    ...
    c &&
      (b
        ? delete c.data[b]
        : (c.handle && (c.events.$destroy && c.handle({}, '$destroy'), Oc(a)), delete hb[d], (a.ng339 = u)))
  }
  function yb (a, b) {
    var d = a.ng339,
      d = d && hb[d]
    ...
    function g (a) {
      ...
      q(a, function (a) {
        ...
        if (!m.get(a)) {
          ...
          try {
            y(a)
              ? ((c = Tb(a)), (b = b.concat(g(c.requires)).concat(c._runBlocks)), d(c._invokeQueue), d(c._configBlocks))
              : D(a)
              ? b.push(p.invoke(a))
              : M(a)
              ? b.push(p.invoke(a))
      ...
      return {
        invoke: function (a, b, c, d) {
          ...
          d =
            11 >= Da
              ? !1
              : 'function' === typeof a && /^(?:class\s|constructor\()/.test(Function.prototype.toString.call(a))
      ...
      function (a, b, c, m, v, Q, t, G, C, K) {
        ...
        function ba (a, b, c, d, e) {
          ...
          return function (b, c, d) {
            ...
            m ||
              (m = (d = d && d[0]) ? ('foreignobject' !== oa(d) && ka.call(d).match(/SVG/) ? 'svg' : 'html') : 'html')
            d =
              'html' !== m
                ? H(
                    ca(
          ...
          for (var h = [], k, l, m, n, r, p = 0; p < a.length; p++) {
            ...
            k =
              (f && f.terminal) || !(m = a[p].childNodes) || !m.length
                ? null
                : xa(m, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b)
          ...
          switch (a.nodeType) {
            case 1:
              ...
              for (var l, m, n, r = a.attributes, p = 0, G = r && r.length; p < G; p++) {
                ...
                ;(l = l.match(Ba)) &&
                  R(l[1]) &&
                  ((v = k), (C = k.substr(0, k.length - 5) + 'end'), (k = k.substr(0, k.length - 6)))
                l = ya(k.toLowerCase())
                h[l] = k
        ...
        function ra (a, b, d, e, f, g, h, k, l) {
          ...
          function n (a, c, e, f, g) {
            ...
            for (r in K) {
              ...
              var L = Va()
              L !== Va.instance &&
                ((Va.instance = L), t.data('$' + p.name + 'Controller', L), m && m(), (m = ha(I, f, Va.instance, Q, p)))
            }
            q(v, function (a, b) {
              var c = a.require
          ...
          for (
            ...
            if ((y = B.scope))
              B.templateUrl ||
                (J(y) ? (X('new/isolated scope', C || G, B, t), (C = B)) : X('new/isolated scope', C, B, t)),
                (G = G || B)
            L = B.name
            ...
            !B.templateUrl &&
              B.controller &&
              ((y = B.controller), (v = v || V()), X("'" + L + "' controller", v[L], B, t), (v[L] = B))
            if ((y = B.transclude))
        ...
        function aa (a, b, c, d, e, f, g, h) {
          ...
          return function (a, b, c, d, e) {
            a = e
            b.$$destroyed ||
              (k ? k.push(b, c, d, a) : (l.transcludeOnThisElement && (a = s(b, l.transclude, e)), l(n, b, c, d, a)))
          }
        }
        function Z (a, b) {
      ...
      function (a, b, d, c, e) {
        ...
        f.cancel = function (a) {
          return a && a.$$intervalId in g
            ? (g[a.$$intervalId].reject('canceled'), b.clearInterval(a.$$intervalId), delete g[a.$$intervalId], !0)
            : !1
        }
        return f
      }
          ...
          if (x || m)
            (x = !1),
              d.$evalAsync(function () {
                ...
                l.absUrl() === b &&
                  (c ? (l.$$parse(a), (l.$$state = f)) : (m && h(b, g, f === l.$$state ? null : l.$$state), k(a, f)))
              })
          l.$$replace = !1
        })
        return l
                  ...
                  if (za(e))
                    ...
                    for (b in e)
                      va.call(e, b) &&
                        ...
                        (g = e[b]),
                        (h = f[b]),
                        b in f ? ((d = h !== h && g !== g), d || h === g || (l++, (f[b] = g))) : (v++, (f[b] = g), l++))
                    ...
                    try {
                      if ((a = p[r]))
                        if (
                          ((m = a.get),
                          (g = m(F)) !== (k = a.last) &&
                            !(a.eq ? na(g, k) : 'number' === typeof g && 'number' === typeof k && isNaN(g) && isNaN(k)))
                        )
                          (q = !0),
                            (c = a),
                  ...
                  function () {
                    ...
                    if (a.computed)
                      (h = k.nextId()),
                        ...
                        e &&
                          1 !== e &&
                          k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), '{}')),
    ...
    Lg = [
      ...
      function (a, b, d, c, e, f, g, h, k, l) {
        ...
        this.$$debounceViewValueCommit = function (b) {
          ...
          d &&
            A(d.debounce) &&
            ((d = d.debounce), R(d) ? (c = d) : R(d[b]) ? (c = d[b]) : R(d['default']) && (c = d['default']))
          g.cancel(y)
          c
            ? (y = g(function () {
                r.$commitViewValue()
                ...
                : ((u.writeValue = function (a) {
                    ...
                    b && !b.disabled
                      ? (g[0].value !== b.selectValue &&
                          (G.remove(), t || w.remove(), (g[0].value = b.selectValue), (b.element.selected = !0)),
                        b.element.setAttribute('selected', 'selected'))
                      : null === a || t
                      ? (G.remove(), t || g.prepend(w), g.val(''), w.prop('selected', !0), w.attr('selected', !0))
                      : (t || w.remove(), g.prepend(G), g.val('?'), G.prop('selected', !0), G.attr('selected', !0))
                  }),
                  (u.readValue = function () {
          ...
          link: function (f, g, h) {
            ...
            f.$watch(l, function (b) {
              ...
              c === v ||
                ...
                (e = s[c]),
                z(e)
                  ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), (w = E), k())
                  : (w = f.$watch(e, k)),
                (v = c))
            })
          }
          ...
          compile: function (f, g) {
            ...
            if (
              ...
              (!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(p) ||
                /^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(p))
            )
              throw c('badident', p)
            var r,
              w,
            ...
            return function (a, d, f, g, l) {
              ...
              a.$watchCollection(n, function (f) {
                ...
                p && (a[p] = f)
                if (za(f)) (I = f), (n = w || v)
                else for (J in ((n = w || z), (I = []), f)) va.call(f, J) && '$' !== J.charAt(0) && I.push(J)
                A = I.length
                J = Array(A)
                for (g = 0; g < A; g++)
...
;(function (E, w, Va) {
  ...
  function T (a, b, c) {
    ...
    c.preparationClasses &&
      ((d.preparationClasses = W(c.preparationClasses, d.preparationClasses)), delete c.preparationClasses)
            ...
            function k (a, g, k) {
              ...
              c.$$postDigest(function () {
                var b = z.get(t),
                  c = !b,
                  b = b || {},
                  d = 0 < (a.parent() || []).length && ('animate' === b.event || b.structural || e(b))
                if (c || b.counter !== M || !d) {
                  c && (Ja(a, h), ha(a, h))
        ...
        this.$get = [
          ...
          function (a, e, f, r, x, F, u, l) {
            function w (a, b) {
              var c = a.parentNode
              return (
                (c.$$ngAnimateParentKey || (c.$$ngAnimateParentKey = ++P)) + '-' + a.getAttribute('class') + '-' + b
              )
            }
            function s (k, h, f, l) {
              var n
            ...
            return function (a, c) {
              ...
              0 < g.stagger
                ? ((t = parseFloat(g.stagger)),
                  (U = { transitionDelay: t, animationDelay: t, transitionDuration: 0, animationDuration: 0 }))
              ...
              p.applyTransitionDuration =
                x && ((p.hasTransitions && !p.hasTransitionAll) || (p.hasAnimations && !p.hasTransitions))
              ...
              if (p.applyTransitionDuration || p.applyAnimationDuration)
                (L = g.duration ? parseFloat(g.duration) : L),
                  p.applyTransitionDuration &&
                    ...
                    y.push(Ea(L, t))),
                  p.applyAnimationDuration && ((p.hasAnimations = !0), (B.animationDuration = L), y.push([wa, L + 's']))
            ...
            function l (c, e, f) {
              ...
              function l () {
                var c = F(f.attr('class') || ''),
                  d = u(c, n),
                  c = u(n, c),
                  d = a(r, { to: k(f), addClass: 'ng-anchor-in ' + d, removeClass: 'ng-anchor-out ' + c, delay: !0 })
              ...
              function A (a, b, d, e, g) {
                ...
                if (0 === f.length) {
                  ...
                  'beforeSetClass' === g
                    ...
                    : 'setClass' === g &&
                      ((h = s(a, 'removeClass', d, e, 'removeClass')), (k = s(a, 'addClass', d, e, 'addClass')))
                  h && (f = f.concat(h))
                  k && (f = f.concat(k))
                }
                if (0 !== f.length)
...
;(function (A, e, B) {
  ...
  ;(function (a) {
    ...
    1 === c.length
      ? (g = c[0])
      : ((c = a.createElement('html')), (g = a.createElement('body')), c.appendChild(g), a.appendChild(c))
  })(A)
      ...
      var o,
        ...
        y = {
          ...
          date: {
            encode: function (a) {
              return this.is(a)
                ? [a.getFullYear(), ('0' + (a.getMonth() + 1)).slice(-2), ('0' + a.getDate()).slice(-2)].join('-')
                : c
            },
            decode: function (a) {
      ...
      ;(s.$$getDefaultValue = function (a) {
        ...
        (this.Param = function (a, b, d, e) {
          ...
          function p (a, b, d, e) {
            var f,
              g,
              i = [{ from: '', to: d || b ? c : '' }, { from: null, to: d || b ? c : '' }]
            return (
      ...
      function u (a, e, f, h, m, o, p) {
        ...
        return (
          ...
          (x.transitionTo = function (b, c, f) {
            ;(c = c || {}),
              (f = M({ location: !0, inherit: !1, relative: null, notify: !0, reload: !1, $retry: !1 }, f || {}))
            var g,
              j = x.$current,
              m = x.params,
              n = j.path,
    ...
    function v () {
      function a (a, b) {
        return {
          load: function (c, d) {
            var e,
              f = { template: null, controller: null, view: null, locals: null, notify: !0, async: !0, params: {} }
            return (
              (d = M(f, d)),
      ...
      r(g, 0, !1),
        i.$watchCollection(x, function (e) {
          if (((P = e || (e = [])), !angular.isArray(e)))
            throw new Error("collection-repeat expected an array for '" + B + "', but got a " + typeof value)
          ...
          for (n = F; W >= n; n++)
            n >= A.length ||
              ...
              (r.secondaryPos !== l.secondaryPos || r.primaryPos !== l.primaryPos) &&
                (r.node.style[ionic.CSS.TRANSFORM] = O.replace(N, (r.primaryPos = l.primaryPos)).replace(
                  z,
              ...
              (r.secondarySize !== l.secondarySize || r.primarySize !== l.primarySize) &&
                (r.node.style.cssText = r.node.style.cssText.replace(
                  m,
                  H.replace(N, (r.primarySize = l.primarySize) + 1).replace(z, (r.secondarySize = l.secondarySize))
                )))
          for (
            W === A.length - 1 &&
            ((l = ee.getDimensions(A.length - 1) || i),
            (w.style[ionic.CSS.TRANSFORM] = O.replace(N, l.primaryPos + l.primarySize).replace(z, 0)));
            G.length;
        ...
        ;(this.getDimensions = function (t) {
          ...
          (this.updateRenderRange = function (e, t) {
            ;(F = Math.max(0, this.getEstimatedIndex(e))),
              (W = Math.min(A.length - 1, this.getEstimatedIndex(t) + this.estimatedItemsAcross - 1)),
      ...
      function p () {
            ...
            (r = c[t - 1] || i),
              ...
              0 === t || a.secondaryPos + a.secondarySize > o.scrollSecondarySize
                ...
                : ((a.primarySize = o.getItemPrimarySize(t, A[t])),
                  ...
                  (c[a.rowStartIndex].rowPrimarySize = a.rowPrimarySize = Math.max(
        ...
        ;(this.getContentSize = function () {
          ...
          (this.getDimensions = function (e) {
            return (
              ...
              e > n && (e > 0.9 * A.length ? (a(A.length - 1), (n = A.length - 1), Q()) : (a(e), (n = e), r())),
              c[e]
            )
          })
        var s = -1,
        ...
        this.updateRenderRange = function (e, t) {
          ...
          ;(W = Math.min(n, A.length - 1)),
            (X = -1 !== W ? (o = this.getDimensions(W)).primaryPos + (o.rowPrimarySize || o.primarySize) : -1),
            (l = e),
            (s = F)
        }
      }
      ...
      ;(this.refreshLayout = function () {
        ...
        if (
          ...
          (B.__clientHeight && B.__clientWidth) ||
            ((B.__clientWidth = B.__container.clientWidth), (B.__clientHeight = B.__container.clientHeight)),
        ...
        ;(ie = !0),
          ie && oe && ((B.__scrollLeft > B.__maxScrollLeft || B.__scrollTop > B.__maxScrollTop) && B.resize(), r(!0))
      }),
                ...
                if ((b !== l && ((b = l), L++), C)) (z = C.viewId), (O = C.action), (H = C.direction), (C = null)
                    ...
                    M.historyId === $.historyId
                      ...
                      : $ &&
                        ...
                        i && i.parentHistoryId === $.historyId
                          ? (H = E)
                          : ((i = f($.historyId)), i && i.parentHistoryId === d.parentHistoryId && (H = _)))
                  ...
                  if (((z = ionic.Utils.nextUid()), $)) {
                    if (
                      (($.forwardViewId = z),
                      (O = I),
                      N && $.stateId !== N.stateId && $.historyId === N.historyId && (i = f(N.historyId)))
                    ) {
                    ...
                    d.historyId === $.historyId
                      ...
                      : $.historyId !== d.historyId &&
                        ...
                        i && i.parentHistoryId === d.parentHistoryId
                          ? (H = _)
                          : ((i = f(i.parentHistoryId)), i && i.historyId === d.historyId && (H = P)))
                  } else O = T
                  2 > L && (H = D),
                ...
                if ((S && S(), o.cancel(k), y)) {
                  if ((y.disableAnimate && (H = D), y.disableBack && (R.views[z].backViewId = null), y.historyRoot)) {
                    for (a = 0; a < d.stack.length; a++)
                      d.stack[a].viewId === z
                        ? ((d.stack[a].index = 0), (d.stack[a].backViewId = d.stack[a].forwardViewId = null))
          ...
          e.$on('$ionicView.beforeEnter', function () {
            ...
            e.$on('$ionicHistory.change', function (e, i) {
              ...
              !i.url && i.uiSref && (i.url = t.href(i.uiSref)),
                i.url &&
                  (0 === i.url.indexOf('#') && (i.url = i.url.replace('#', '')), i.url !== n.url() && n.url(i.url))
            }),
      ...
      .provider('$ionicConfig', function () {
        ...
        function t (e, n) {
          for (var i in e)
            i != r &&
              e.hasOwnProperty(i) &&
              (angular.isObject(e[i]) ? (l(n[i]) || (n[i] = {}), t(e[i], n[i])) : l(n[i]) || (n[i] = null))
        }
        function n (e, t, o) {
          s(e, function (c, s) {
          ...
          (o.transitions.views.ios = function (e, t, n, i) {
            function o (e, t, n, i) {
              ...
              ;(o[ionic.CSS.TRANSITION_DURATION] = r.shouldAnimate ? '' : 0),
                (o.opacity = t),
                i > -1 && (o.boxShadow = '0 0 10px rgba(0,0,0,' + (r.shouldAnimate ? 0.45 * i : 0.3) + ')'),
    ...
    function (e, t, n, i, o, r, a, s, l, u, d) {
              ...
              return (
                (e.show = function (a) {
                  ...
                  ;(e.scope = a.scope || e.scope),
                    ...
                    a.duration &&
                      (o.cancel(e.durationTimeout), (e.durationTimeout = o(angular.bind(e, e.hide), +a.duration))),
                    $(),
                ...
                (e.hide = function () {
                  $(),
                    e.isShown &&
                      (e.hasBackdrop && (i.release(), i.getElement().removeClass('backdrop-loading')),
      ...
      function v (t) {
        ...
        return (
          w(),
          b(),
          t.hideOnStateChange && ((w = u.$on('$stateChangeSuccess', g)), (b = u.$on('$stateChangeError', g))),
          o.cancel(y),
          (y = o(h, n)),
        ...
        return (
          ...
          (s.show = function () {
            s.isShown ||
              ...
              ionic.requestAnimationFrame(function () {
                s.isShown &&
                  (s.element.removeClass('popup-hidden'), s.element.addClass('popup-showing active'), m(s.element))
              }))
          }),
          (s.hide = function (e) {
            return (
        ...
        return {
          position: function (t) {
            var n = this.offset(t),
              ...
              r = o(t[0])
            r != e[0] &&
              ((i = this.offset(f(r))), (i.top += r.clientTop - r.scrollTop), (i.left += r.clientLeft - r.scrollLeft))
              ...
              if ('object' == typeof r) {
                ...
                if ((a && d(r.templateUrl) && e.push(r.templateUrl), angular.isObject(r.views)))
                  for (var c in r.views)
                    (a = r.views[c].prefetchTemplate !== !1 && e.length < n.templates.maxPrefetch()),
      ...
      function (e, t, n, i, o, r) {
        ...
        function s (n) {
          ...
          return r.then(function (i) {
            ...
            return (
              n.controller &&
                ((r = t(n.controller, c(n.locals, { $scope: a }))), s.children().data('$ngControllerController', r)),
                ...
                q = {
                  ...
                  transition: function (a, l, u) {
                    ...
                    function m () {
                      m.x ||
                        ...
                        z && e.cancel(z.data(I)),
                        C && C.resolve(t),
                        H === P && (n.all(L).then(M.transitionEnd), q.emit('after', T, B), q.cleanup(T)),
                        r._instances.forEach(function (e) {
                  ...
                  emit: function (e, t, n) {
                    ...
                    !t.viewId || t.abstractView
                      ...
                      : ('after' == e &&
                          (o && (o.$emit('$ionicView.enter', t), o.$broadcast('$ionicParentView.enter', t)),
                          r
                            ? (r.$emit('$ionicView.leave', n), r.$broadcast('$ionicParentView.leave', n))
                            : o &&
                              n &&
                              n.viewId &&
                              t.stateName !== n.stateName &&
                              ((i = g(t.stateName, n.stateName)), i && o.$emit('$ionicNavView.leave', n))),
                        o &&
                          (o.$emit('$ionicView.' + e + 'Enter', t), o.$broadcast('$ionicParentView.' + e + 'Enter', t)),
                        r
                          ...
                          : o &&
                            ...
                            n.viewId &&
                            t.stateName !== n.stateName &&
                            ((i = g(t.stateName, n.stateName)), i && o.$emit('$ionicNavView.' + e + 'Leave', n)))
                  },
                  cleanup: function (e) {
                    ...
                    for (n = 0; c > n; n++)
                      (i = a.eq(n)),
                        s && i.data(T) < l ? ((l = i.data(T)), (r = a.eq(n))) : i.data(k) && p(i) != A && v(i)
              ...
              return e && e.$template && ((n.innerHTML = e.$template), 1 === n.children.length)
                ? (n.children[0].classList.add('pane'),
                  e.$$state && e.$$state.self && e.$$state.self['abstract']
                    ...
                    : e.$$state && e.$$state.self && angular.element(n.children[0]).attr('state', e.$$state.self.name),
                  f(n.children[0]))
      ...
      function (e, t, n, i, o, r) {
        ...
        ;(h.beforeEnter = function (t) {
          ...
          (h.updateBackButton = function () {
            var e
            ;(b && y && w) !== S && ((S = b && y && w), (e = a(l)), e && e.classList[S ? 'remove' : 'add'](f)),
              w &&
                ((e = e || a(l)),
                e &&
                  (h.backButtonIcon !== o.backButton.icon() &&
                    ((e = a(l + ' .icon')),
                    e && ((h.backButtonIcon = o.backButton.icon()), (e.className = 'icon ' + h.backButtonIcon))),
                  h.backButtonText !== o.backButton.text() &&
                    ((e = a(l + ' .back-text')), e && (e.textContent = h.backButtonText = o.backButton.text()))))
          }),
            ...
            i(
              function () {
                s.jsScrolling && s.scrollView.resize(),
                  ((s.jsScrolling && s.scrollView.__container && s.scrollView.__container.offsetHeight > 0) ||
                    !s.jsScrolling) &&
                    s.checkBounds()
              },
              30,
        ...
        ;(s.isLoading = !1),
          ...
          (s.getNativeMaxScroll = function () {
            ...
            return {
              left:
                !e.left ||
                ('scroll' !== t.overflowX && 'auto' !== t.overflowX && 'scroll' !== s.scrollEl.style['overflow-x'])
                  ? -1
                  : c(e.left),
              top:
                !e.top ||
                ('scroll' !== t.overflowY && 'auto' !== t.overflowY && 'scroll' !== s.scrollEl.style['overflow-y'])
                  ? -1
                  : c(e.top)
            }
          }),
            ...
            function r (e, t) {
              e &&
                ('title' === t
                  ...
                  : (p || ((p = f('<div class="buttons buttons-left">')), m[C] ? m[C].after(p) : h.prepend(p)),
        ...
        ;(x.scope = e),
              ...
              (i = o.eq(e)),
                i.data(k) === b
                  ...
                  : ('leaving' === V(i) || V(i) === I || V(i) === B) &&
                    (i.data(C) || i.data(T) ? l.destroyViewEle(i) : (V(i, B), ionic.Utils.disconnectScope(i.scope())))
          ...
          (x.clearCache = function (e) {
            ...
            for (o = 0, r = s.length; r > o; o++)
              if (((n = s.eq(o)), e)) for (c = n.data(k), a = 0; a < e.length; a++) c === e[a] && l.destroyViewEle(n)
              else
                V(n) == B
                  ? l.destroyViewEle(n)
    ...
    a.controller('$ionicRefresher', [
      ...
      function (e, t, n, i, o) {
        ...
        function c () {
          ;(P = null),
            (D || T) &&
              (T ? ((T = !1), (B = 0), x > A ? ($(), p(A, E)) : (p(0, E, m), (I = !1))) : ((B = 0), (I = !1), h(!1)))
        }
        function s (e) {
          if (
            ((e.touches = e.touches || [{ screenX: e.screenX, screenY: e.screenY }]),
        ...
        function p (e, t, n) {
          ...
          function o () {
            ...
            d(Math.floor(l * (e - a) + a)),
              1 > s ? ionic.requestAnimationFrame(o) : (5 > e && e > -5 && ((I = !1), h(!1)), n && n())
          }
          var r = Date.now(),
            a = x
        ...
        l(t.bouncing) ||
          ionic.Platform.ready(function () {
            u &&
              ...
              ionic.Platform.isAndroid() && ((u.options.bouncing = !1), (u.options.deceleration = 0.95)))
          })
            ...
            s.resize().then(function () {
              if (u) {
                ...
                var i = n,
                  a = 0,
                  c = 0
                do null !== i && (a += i.offsetLeft), null !== i && (c += i.offsetTop), (i = i.offsetParent)
      ...
      function (e, t, n, i, o, r, a, c, s) {
        ...
        ;($.$scope = e),
          ...
          ($.openPercentage = function (e) {
            var t = e / 100
            $.left && e >= 0 ? $.openAmount($.left.width * t) : $.right && 0 > e && $.openAmount($.right.width * t),
          ...
          ($.openAmount = function (e) {
            ...
            return (($.left && $.left.isEnabled) || !(e > 0)) && (($.right && $.right.isEnabled) || !(0 > e))
              ? d && e > t
                ...
                : ($.content.setTranslateX(e),
                  ...
                  (l = 0 > e),
                  void (e > 0
                    ? ($.right && $.right.pushDown && $.right.pushDown(), $.left && $.left.bringUp && $.left.bringUp())
        ...
        e.$on('$destroy', function () {
          S(),
            b(),
            ($.$scope = null),
            $.content && ($.content.setCanScroll(!0), ($.content.element = null), ($.content = null))
        }),
                ...
                linearGradient: [
                  {
                    ...
                    x2: 2,
                    y2: 46,
                    stop: [{ offset: 0.1, class: 'stop1' }, { offset: 1, class: 'stop2' }]
                  }
                ]
              }
            ],
      ...
      function (e, t, n) {
        ...
        ;(o.tabs = []),
            ...
            1 === arguments.length && (a = !(!t.navViewName && !t.uiSref)),
              r && r.$historyId == t.$historyId
                ...
                : i !== c &&
                  ...
                  (r = t),
                  (i = c),
                  o.$scope && o.$scope.$parent && (o.$scope.$parent.$activeHistoryId = t.$historyId),
                  (t.$tabSelected = !0),
                  (t.onSelect || h)(),
                  a &&
          ...
          (o.showBar = function (e) {
            return (
              arguments.length && (e ? t.removeClass('tabs-item-hide') : t.addClass('tabs-item-hide'), (c = !!e)), c
            )
          })
      }
    ]),
          ...
          compile: function (t, n) {
            ...
            if (o) {
              ...
              r.addClass('item-content'),
                (l(n.href) || l(n.ngHref)) &&
                  (r.attr('ng-href', '{{$href()}}'), l(n.target) && r.attr('target', '{{$target()}}')),
                r.append(t.contents()),
      ...
      return {
        ...
        compile: function (t, n) {
          return (
            ...
            function (t, n, i, o) {
              o.optionsContainer || ((o.optionsContainer = f(S)), o.$element.prepend(o.optionsContainer)),
          ...
          compile: function (n, i) {
            ...
            if (
              (!d &&
                h &&
                'none' !== h &&
                ((r.innerHTML = '<i class="icon ' + h + '"></i> ' + r.innerHTML), (r.className += ' button-clear')),
              !s)
            ) {
        ...
        return {
          ...
          compile: function (e, o) {
            function r (e, i, o) {
              function r () {
                e.$onScrollComplete &&
                  e.$onScrollComplete({ scrollTop: d.scrollView.__scrollTop, scrollLeft: d.scrollView.__scrollLeft })
              }
              n(e, o, {
                direction: '@',
                paging: '@',
            ...
            function r (r, a, c, s) {
              ...
              var m = {
                ...
                setMarginRight: ionic.animationFrameThrottle(function (e) {
                  e
                    ? ((e = parseInt(e, 10)), (a[0].style.width = n.innerWidth - e + 'px'), (m.offsetX = e))
        ...
        function (e, t, n, i, o, r) {
          return {
            ...
            controller: [
              ...
              function (e, n, a) {
                function c (e) {
                  e && !s.isScrollFreeze ? r.freezeAllScrolls(e) : !e && s.isScrollFreeze && r.freezeAllScrolls(!1),
                    (s.isScrollFreeze = e)
                }
                var s = this,
            ...
            return (
              u &&
                ('ION-NAV-VIEW' === s.children[0].tagName &&
                  ((d = s.children[0].getAttribute('name')), s.children[0].classList.add('view-container'), (h = !0)),
                1 === u && (s = s.children[0]),
              ...
              function (o, r, a, l) {
                ...
                function p (n) {
                  n && u
                    ? (b ||
                        ((g = o.$new()), (m = f(s)), i.viewEleIsActive(m, !0), $.$element.append(m), e(m)(g), (b = !0)),
