...
module.exports = function (middleware: any, router: any, controllers: any) {
  // Shorten Vars
  ...
  router.post('/api/v2/tickets/deleted/restore', apiv2Auth, isAdmin, apiv2.tickets.restoreDeleted)
  ...
  router.post('/api/v2/settings/general/uploadlogo', apiv2Auth, isAdmin, apiv2.settings.uploadLogo)
  router.post('/api/v2/settings/general/uploadpagelogo', apiv2Auth, isAdmin, apiv2.settings.uploadPageLogo)
  router.post('/api/v2/settings/general/uploadfavicon', apiv2Auth, isAdmin, apiv2.settings.uploadFavicon)
