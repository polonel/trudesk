...
@observer
class SettingsNotificationTemplates extends React.Component {
    ...
    return this.templates.map((template, idx) => {
      ...
      return {
        ...
        bodyComponent: templateBody({
          ...
          handleOpenEditor: e => SettingsNotificationTemplates.onOpenEditor(e, templateJS.name)
        })
      }
    })
  }
    ...
    return (
      <div>
        <TitleContext.Consumer>
          {({ title }) => (
            <Helmet>
              <title>{title} Notification Templates</title>
            </Helmet>
          )}
        </TitleContext.Consumer>
        <PageTitle
          breadcrumbs={
            <Breadcrumbs
              links={[
                ...
                { url: '/v2settings/mailnotificationtemplates', title: 'Notification Templates', active: true }
              ]}
        ...
        <div style={{ display: 'flex', height: '100vh' }}>
          ...
          <div className={'info-sidebar'}>
            <h3>[BETA]</h3>
            <p>Mail Notifications are currently under active development.</p>
            <h3>Editor</h3>
            <p>The editor is currently disabled due to a unresolved bug.</p>
          </div>
        </div>
      </div>
    )
...
SettingsNotificationTemplates.propTypes = {
...
export default connect(mapStateToProps, { fetchSettings, updateSetting })(SettingsNotificationTemplates)
