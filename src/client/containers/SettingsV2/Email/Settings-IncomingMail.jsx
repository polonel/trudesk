...
class SettingsIncomingMail extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      mailerCheckHost: '',
  ...
  static getDerivedStateFromProps (nextProps, state) {
    ...
    if (nextProps.settings) {
      ...
      if (stateObj.mailerCheckTicketType)
        stateObj.typePriorities = SettingsIncomingMail.getTypePriorities(
    ...
    return (
      <div>
        <TitleContext.Consumer>
          {({ title }) => (
            <Helmet>
              <title>{title} Incoming Mail</title>
            </Helmet>
          )}
        </TitleContext.Consumer>
        <PageTitle
          breadcrumbs={
            <Breadcrumbs
              links={[
                ...
                { url: '/v2settings/incomingmail', title: 'Incoming Mail', active: true }
              ]}
        ...
        <div style={{ display: 'flex', height: '100vh' }}>
          <div style={{ flexGrow: 1, padding: 15 }}>
            <SettingItem
              ...
              subtitle={
                <div>
                  Poll an IMAP mailbox for messages to convert to tickets -{' '}
                  <i>Settings are applied after server restart</i>
                </div>
              }
              component={
                <EnableSwitch
          ...
          <div className={'info-sidebar'}>
            <h3>Mail Server</h3>
            <p>Hostname or IP Address of the IMAP server used to receive mail.</p>
            <h3>Port</h3>
            <p>Port used to connect to the IMAP server.</p>
            <h3>Auth Username/Password</h3>
            <p>Username and Password for IMAP authentication.</p>
          </div>
        </div>
      </div>
    )
...
SettingsIncomingMail.propTypes = {
...
export default connect(mapStateToProps, { fetchSettings, updateSetting, updateMultipleSettings })(SettingsIncomingMail)
