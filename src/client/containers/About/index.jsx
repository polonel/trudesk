...
import { hideModal, showModal } from 'actions/common'
      ...
      <div className="nopadding page-content">
        ...
        C236.3,23.1,238.1,12.5,238.1,6.9z"
            ...
            <div style={{ paddingLeft: 40 }}>
              <h6 style={{ marginBottom: 0 }}>Trudesk version {this.props.viewdata.get('version')}</h6>
              <h5 style={{ fontWeight: 500, marginBottom: 15 }}>Community Edition</h5>
              <p style={{ fontSize: '12px' }}>
                Copyright &copy;2014-2022 Trudesk, Inc. (Chris Brame)
                <br/> <br/>
