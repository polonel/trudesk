...
function CommentNotePartial ({ ticketStatus, ticketSubject, comment, isNote, dateFormat, onEditClick, onRemoveClick }) {
  const bodyRef = useRef(null)
  const content = isNote ? comment.note : comment.comment
