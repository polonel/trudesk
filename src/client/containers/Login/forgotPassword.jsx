  ...
  return (
    <div style={{ overflow: 'auto' }}>
      <TitleContext.Consumer>
        {({ title }) => (
          <Helmet>
            <title>{title} Reset Password - Powered by Trudesk</title>
          </Helmet>
        )}
      </TitleContext.Consumer>
      {error && (
          ...
          <div className='login-wrapper' style={{ background: 'var(--pagecontentlight10)' }}>
            ...
            <div className='loginForm'>
              <Form
                ...
                onValidate={(e, data) => {
                  if (!data.email || !helpers.isValidEmail(email)) {
                    setPending(false)
                    setSuccess(false)
                    setButtonText('Send Reset Password')
                ...
                onError={err => {
                  ...
                  else setError('Unable to reset account password')
