...
const setTheme = colorScheme => {
  ...
  const tertiaryFade = color(tertiary)
    .fade(0.15)
    .toString()
  const tertiaryFade25 = color(tertiary)
    .fade(0.75)
    .toString()
  ...
  const pageContentLight20 = color(secondary)
    ...
    .hex()
    .toString()
  const pageContentLight30 = color(secondary)
    .lighten(0.3)
    .hex()
    .toString()
  ...
  html.style.setProperty('--tertiaryfade25', tertiaryFade25)
  ...
  html.style.setProperty('--pagecontentlight30', pageContentLight30)
