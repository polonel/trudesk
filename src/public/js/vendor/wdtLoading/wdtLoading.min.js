!function (e, t) {
    ...
    var s = {};
    s.defaults = {category: "default", speed: 2e3}, s.start = function (e) {
        this.options = o(s.defaults, e), this.wdtLoadingScreen = document.querySelector(".wdt-loading-screen");
        for (var t = document.querySelectorAll(".wdt-loading-phrase-category"), r = 0; r < t.length; r++)i(t[r], {display: "none"});
        ...
        this.phraseHeight = e.wdtPhraseActiveCat.querySelector(".wdt-loading-phrase").scrollHeight, e.currentIndex = 0, e.currentTransform = 0, e.spinInternal = setInterval(function () {
            if (e.activePhrases = e.wdtPhraseActiveCat.querySelectorAll(".wdt-loading-phrase"), t(e.activePhrases[e.currentIndex], "wdt-checked"), e.currentIndex++, e.currentTransform = e.currentTransform - e.phraseHeight, i(e.wdtPhraseActiveCat, {transform: "translateY(" + e.currentTransform + "px)"}), e.currentIndex > 1) {
                var n = e.activePhrases[e.currentIndex - 2], a = n.cloneNode(!0);
                r(a, "wdt-checked"), t(a, "wdt-cloned-phrase"), a.style.transform = "", e.wdtPhraseActiveCat.appendChild(a)
            }
        }, this.options.speed)
    }, s.done = function () {
        this.spinInternal && clearInterval(this.spinInternal), i(this.wdtLoadingScreen, {display: "none"});
    ...
    var o = function () {
        ...
        function t(e) {
            ...
            if (e in t)return e;
            for (var r, n = a.length, s = e.charAt(0).toUpperCase() + e.slice(1); n--;)if (r = a[n] + s, r in t)return r;
            return e
        }
        ...
        var a = ["Webkit", "O", "Moz", "ms"], s = {};
        return function (e, t) {
            var r, a, s = arguments;
            if (2 == s.length)for (r in t)a = t[r], void 0 !== a && t.hasOwnProperty(r) && n(e, r, a); else n(e, s[1], s[2])
        }
    }();
    return s
});