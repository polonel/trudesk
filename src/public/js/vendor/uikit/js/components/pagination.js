...
(function(addon) {
    ...
    UI.component('pagination', {
        ...
        _append: function(pageIndex, opts) {
            ...
            item = (pageIndex == this.currentPage) ? '<li class="uk-active"><span>' + (options.text) + '</span></li>' : '<li><a href="#page-'+(pageIndex+1)+'" class="no-ajaxy" data-page="'+pageIndex+'">'+options.text+'</a></li>';
