;(function (global, factory) {
  ...
  var Translator = (function (_EventEmitter) {
    ...
    function Translator (services) {
      ...
      copy(
        ['resourceStore', 'languageUtils', 'pluralResolver', 'interpolator', 'backendConnector', 'i18nFormat'],
        services,
        _this
      )
      ...
      if (this.i18nFormat && this.i18nFormat.parse) {
        ...
        if (options.interpolation)
          this.interpolator.init(
            _extends({}, options, { interpolation: _extends({}, this.options.interpolation, options.interpolation) })
          )
    ...
    Translator.prototype.resolve = function resolve (keys) {
      ...
      keys.forEach(function (k) {
        ...
        var codes = options.lngs
          ? options.lngs
          : _this4.languageUtils.toResolveHierarchy(options.lng || _this4.language, options.fallbackLng)
