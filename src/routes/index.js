...
function mainRoutes (router, middleware, controllers) {
  ...
  router.get('/logoimage', function (req, res) {
    ...
    s.getSettingByName('gen:customlogo', function (err, hasCustomLogo) {
      if (!err && hasCustomLogo && hasCustomLogo.value) {
        s.getSettingByName('gen:customlogofilename', function (
          err,
          logoFilename
        ) {
  ...
  router.post(
    '/accounts/import/csv/upload',
    middleware.redirectToLogin,
    controllers.accounts.uploadCSV
  )
  router.post(
    '/accounts/import/json/upload',
    middleware.redirectToLogin,
    controllers.accounts.uploadJSON
  )
  router.post(
    '/accounts/import/ldap/bind',
    middleware.redirectToLogin,
  ...
  router.post(
    '/settings/general/uploadlogo',
    middleware.redirectToLogin,
    controllers.main.uploadLogo
  )
  router.post(
    '/settings/general/uploadpagelogo',
    middleware.redirectToLogin,
    controllers.main.uploadPageLogo
  )
  router.post(
    '/settings/general/uploadfavicon',
    middleware.redirectToLogin,
  ...
  router.get(
    '/api/v1/tickets/type/:id',
    middleware.api,
    controllers.api.tickets.getType
  )
  router.post(
    '/api/v1/tickets/type/:id/removepriority',
    middleware.api,
    controllers.api.tickets.typeRemovePriority
  )
  router.post(
    '/api/v1/tickets/type/:id/addpriority',
    middleware.api,
    controllers.api.tickets.typeAddPriority
  )
  router.get(
    '/api/v1/tickets/types',
    middleware.api,
    controllers.api.tickets.getTypes
  )
  router.post(
    '/api/v1/tickets/types/create',
    middleware.api,
    controllers.api.tickets.createType
  )
  router.put(
    '/api/v1/tickets/types/:id',
    middleware.api,
    controllers.api.tickets.updateType
  )
  router.delete(
    '/api/v1/tickets/types/:id',
    middleware.api,
    controllers.api.tickets.deleteType
  )
  router.post(
    '/api/v1/tickets/priority/create',
    middleware.api,
    controllers.api.tickets.createPriority
  )
  router.post(
    '/api/v1/tickets/priority/:id/delete',
    middleware.api,
    controllers.api.tickets.deletePriority
  )
  router.get(
    '/api/v1/tickets/priorities',
    middleware.api,
    controllers.api.tickets.getPriorities
  )
  router.put(
    '/api/v1/tickets/priority/:id',
    middleware.api,
    controllers.api.tickets.updatePriority
  )

  router.get(
    '/api/v1/tickets/overdue',
    middleware.api,
    controllers.api.tickets.getOverdue
  )
  router.post(
    '/api/v1/tickets/addcomment',
    middleware.api,
    controllers.api.tickets.postComment
  )
  router.post(
    '/api/v1/tickets/addnote',
    middleware.api,
    controllers.api.tickets.postInternalNote
  )
  router.get(
    '/api/v1/tickets/tags',
    middleware.api,
    controllers.api.tickets.getTags
  )
  router.get(
    '/api/v1/tickets/count/tags',
    middleware.api,
    controllers.api.tickets.getTagCount
  )
  router.get(
    '/api/v1/tickets/count/tags/:timespan',
    middleware.api,
    controllers.api.tickets.getTagCount
  )
  router.get(
    '/api/v1/tickets/count/days',
    middleware.api,
    controllers.api.tickets.getTicketStats
  )
  router.get(
    '/api/v1/tickets/count/days/:timespan',
    middleware.api,
    controllers.api.tickets.getTicketStats
  )
  router.get(
    '/api/v1/tickets/count/topgroups',
    middleware.api,
    controllers.api.tickets.getTopTicketGroups
  )
  router.get(
    '/api/v1/tickets/count/topgroups/:top',
    middleware.api,
    controllers.api.tickets.getTopTicketGroups
  )
  router.get(
  ...
  router.get(
    '/api/v1/tickets/stats/group/:group',
    middleware.api,
    controllers.api.tickets.getTicketStatsForGroup
  )
  router.get(
    '/api/v1/tickets/stats/user/:user',
    middleware.api,
    controllers.api.tickets.getTicketStatsForUser
  )
  router.get(
    '/api/v1/tickets/stats/:timespan',
    middleware.api,
    controllers.api.tickets.getTicketStats
  )
  router.get(
    '/api/v1/tickets/:uid',
    middleware.api,
    controllers.api.tickets.single
  )
  router.put(
    '/api/v1/tickets/:id',
    middleware.api,
    controllers.api.tickets.update
  )
  router.delete(
    '/api/v1/tickets/:id',
    middleware.api,
    controllers.api.tickets.delete
  )
  router.put(
    '/api/v1/tickets/:id/subscribe',
    middleware.api,
    controllers.api.tickets.subscribe
  )
  router.delete(
  ...
  router.post(
    '/api/v1/tags/create',
    middleware.api,
    controllers.api.tags.createTag
  )
  router.get(
    '/api/v1/tags/limit',
    middleware.api,
    controllers.api.tags.getTagsWithLimit
  )
  router.put('/api/v1/tags/:id', middleware.api, controllers.api.tags.updateTag)
  router.delete(
    '/api/v1/tags/:id',
    middleware.api,
    controllers.api.tags.deleteTag
  )
  ...
  router.get(
    '/api/v1/groups/all',
    middleware.api,
    controllers.api.groups.getAll
  )
  router.post(
    '/api/v1/groups/create',
    middleware.api,
    controllers.api.groups.create
  )
  router.get(
    '/api/v1/groups/:id',
    middleware.api,
    controllers.api.groups.getSingleGroup
  )
  router.delete(
    '/api/v1/groups/:id',
    middleware.api,
    controllers.api.groups.deleteGroup
  )
  router.put(
    '/api/v1/groups/:id',
    middleware.api,
    controllers.api.groups.updateGroup
  )

  router.get(
    '/api/v1/users',
    middleware.api,
    controllers.api.users.getWithLimit
  )
  router.post(
    '/api/v1/users/create',
    middleware.api,
  ...
  router.get(
    '/api/v1/users/notificationCount',
    middleware.api,
    controllers.api.users.notificationCount
  )
  router.get(
    '/api/v1/users/getassignees',
    middleware.api,
    controllers.api.users.getAssingees
  )
  router.get(
    '/api/v1/users/:username',
    middleware.api,
    controllers.api.users.single
  )
  router.put(
    '/api/v1/users/:username',
    middleware.api,
  ...
  router.post(
    '/api/v1/users/:username/uploadprofilepic',
    controllers.api.users.uploadProfilePic
  )
  router.put(
    '/api/v1/users/:username/updatepreferences',
    middleware.api,
    controllers.api.users.updatePreferences
  )
  router.get(
    '/api/v1/users/:username/enable',
    middleware.api,
    controllers.api.users.enableUser
  )
  router.delete(
    '/api/v1/users/:username',
    middleware.api,
    controllers.api.users.deleteUser
  )
  router.post(
    '/api/v1/users/:id/generateapikey',
    middleware.api,
    controllers.api.users.generateApiKey
  )
  router.post(
    '/api/v1/users/:id/removeapikey',
    middleware.api,
    controllers.api.users.removeApiKey
  )
  router.post(
    '/api/v1/users/:id/generatel2auth',
    middleware.api,
    controllers.api.users.generateL2Auth
  )
  router.post(
    '/api/v1/users/:id/removel2auth',
    middleware.api,
    controllers.api.users.removeL2Auth
  )
  ...
  router.post(
    ...
    middleware.api,
    controllers.api.messages.startConversation
  )
  router.get(
    '/api/v1/messages/conversation/:id',
    middleware.api,
    controllers.api.messages.getMessagesForConversation
  )
  router.delete(
    '/api/v1/messages/conversation/:id',
    middleware.api,
    controllers.api.messages.deleteConversation
  )
  router.get(
    '/api/v1/messages/conversations',
    middleware.api,
    controllers.api.messages.getConversations
  )
  router.get(
    '/api/v1/messages/conversations/recent',
    middleware.api,
    controllers.api.messages.getRecentConversations
  )
  router.post(
    '/api/v1/messages/send',
    middleware.api,
    controllers.api.messages.send
  )

  router.post(
    '/api/v1/notices/create',
    middleware.api,
    controllers.api.notices.create
  )
  router.get(
    '/api/v1/notices/clearactive',
    middleware.api,
    controllers.api.notices.clearActive
  )
  router.put(
    '/api/v1/notices/:id',
    middleware.api,
    controllers.api.notices.updateNotice
  )
  router.delete(
    '/api/v1/notices/:id',
    middleware.api,
    controllers.api.notices.deleteNotice
  )
  ...
  router.get(
    '/api/v1/settings',
    middleware.api,
    controllers.api.settings.getSettings
  )
  router.put(
    '/api/v1/settings',
    middleware.api,
    controllers.api.settings.updateSetting
  )
  router.post(
    '/api/v1/settings/testmailer',
    middleware.api,
    controllers.api.settings.testMailer
  )
  router.get(
    '/api/v1/settings/buildsass',
    middleware.api,
    controllers.api.settings.buildsass
  )
  ...
  router.get(
    ...
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.getBackups
  )
  router.post(
    '/api/v1/backup',
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.runBackup
  )
  router.delete(
    '/api/v1/backup/:backup',
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.deleteBackup
  )
  router.post(
    '/api/v1/backup/restore',
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.restoreBackup
  )
  router.post(
    '/api/v1/backup/upload',
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.uploadBackup
  )
  router.get(
    '/api/v1/backup/hastools',
    middleware.api,
    middleware.isAdmin,
    controllers.backuprestore.hasBackupTools
  )
